...
function callEmbedded() {
    ...
    $.ajax({
        type: "GET",
        url: "http://109.255.19.77:80/FIRE/API/Embedded/embedded.php",
...
function createEmbeddedView(embeddedList) {
    ...
    while (i < embeddedList.length) {
        ...
        htmlText += '<div class="mr-auto ml-auto w-75">';
        htmlText += '<div id="map' + i + '" class="map-view-image mt-5"></div>';
        htmlText += '</div>';
        htmlText += '</div>';
        htmlText += '<div class="mt-3 mb-5 box-embedded">';
        htmlText += '<div class="row pl-3 pr-3 mt-3">';
        htmlText += '<div class="col-2 text-center">';
        htmlText += '<img class="pin-size" src="Images/pin-pos.png">';
        htmlText += '</div>';
        htmlText += '<div class="col-5 text-center">';
        ...
        htmlText += '</div>';
        htmlText += '</div>';
        htmlText += '<div class="row pl-3 pr-3 mt-3 mb-3">';
        htmlText += '<div class="col-2 text-center">';
        ...
        htmlText += '</div>';
        htmlText += '</div>';
        htmlText += '<div class="text-center mb-3">';
